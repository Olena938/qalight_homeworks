...
else:    print("Пароль занадто короткий, спробуйте ще раз")
...
else:    print(f"{year} не є високосним роком")
...
else:    print("Невідомий колір прибульця")  
...
print(f"Найбільше число: {max(input_numbers)}")
